...
var iconTypes = prefix(['success', 'warning', 'info', 'question', 'error']);var getContainer = function getContainer() {
...
};var render$1 = function render(instance, params) {
...
var showLoading = function showLoading(buttonToReplace) {
  ...
  popup.focus();
};var RESTORE_FOCUS_TIMEOUT = 100;var globalState = {};
...
var prepareParams = function prepareParams(userParams, mixinParams) {
  ...
  var showClass = Object.assign({}, defaultParams.showClass, mixinParams.showClass, templateParams.showClass, userParams.showClass);
  var hideClass = Object.assign({}, defaultParams.hideClass, mixinParams.hideClass, templateParams.hideClass, userParams.hideClass);
...
};var instanceMethods=/*#__PURE__*/Object.freeze({__proto__:null,hideLoading: hideLoading,disableLoading: hideLoading,getInput: getInput,close: close,closePopup: close,closeModal: close,closeToast: close,enableButtons: enableButtons,disableButtons: disableButtons,enableInput: enableInput,disableInput: disableInput,showValidationMessage: showValidationMessage,resetValidationMessage: resetValidationMessage,getProgressSteps: getProgressSteps,_main: _main,update: update,_destroy: _destroy});var currentInstance;
...
SweetAlert.version = '10.15.7';var Swal = SweetAlert;
Swal.default = Swal;function errorHandler(noResult, loading, message) {
  var noResultErrMsg = function noResultErrMsg() {
    loading.value = false;
    Swal.fire({
      text: message.value,
  ...
  vue.watch(noResult, function (newValue) {
    if (newValue === true) {
      noResultErrMsg();
    }
  });
  ...
  setup: function setup(props, _ref) {
    ...
    var _toRefs = vue.toRefs(props),
        noResult = _toRefs.noResult,
        message = _toRefs.message;

    var _infiniteScroll = infiniteScroll(noResult, emit),
        handleScroll = _infiniteScroll.handleScroll,
        scrollRef = _infiniteScroll.scrollRef,
        loading = _infiniteScroll.loading;
...
};var _withId = /*#__PURE__*/vue.withScopeId("data-v-eaa4925a");

vue.pushScopeId("data-v-eaa4925a");
...
var render = /*#__PURE__*/_withId(function (_ctx, _cache, $props, $setup, $data, $options) {
  return vue.openBlock(), vue.createBlock("div", _hoisted_1, [vue.renderSlot(_ctx.$slots, "default"), $setup.loading ? (vue.openBlock(), vue.createBlock("div", _hoisted_2, [_hoisted_3])) : vue.createCommentVNode("", true)], 512);
...
script.__scopeId = "data-v-eaa4925a";// Import vue component
